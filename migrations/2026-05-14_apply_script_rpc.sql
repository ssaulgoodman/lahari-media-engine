-- Atomic apply-only script replacement for Codex-native R28.
--
-- The director agent writes the script content; this RPC performs the
-- destructive cast/environment/scene/shot replacement inside one Postgres
-- transaction so partial REST failures cannot leave a project half-scripted.
